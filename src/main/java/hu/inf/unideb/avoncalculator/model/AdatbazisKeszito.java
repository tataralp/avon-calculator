...
public class AdatbazisKeszito {
     ...
     * A naplózó példánya.
     */
	private final static Logger logger = LoggerFactory.getLogger(AdatbazisKeszito.class);
	...
	public static void adatbazisKeszites() {
		...
		try {
			...
			logger.error("Adatbázis hiba történt! " + e.getMessage());
		} finally {
			if (dbKapcsolat != null) {
